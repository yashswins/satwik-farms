...
export const services = {
  'grocery-delivery': {
    ...
    metaDescription:
      'Order fresh residue-free vegetables, fruits, dairy, grains, spices, and household essentials online in Dar es Salaam. Same-day and next-day delivery. Order via WhatsApp or our app.',
    keywords: [
      ...
      'WhatsApp grocery order Tanzania',
    ],
    ...
    features: [
      ...
      'Order easily via WhatsApp or our mobile app',
    ],
  ...
  'dairy-delivery': {
    ...
    metaDescription:
      'Fresh milk, traditionally cultured yoghurt, and pure ghee from happy cattle in Kisarawe — delivered to your door in Dar es Salaam. No hormones, no routine antibiotics. Order via WhatsApp.',
    keywords: [
      'dairy delivery Dar es Salaam',
  ...
  'residue-free-vegetables': {
    ...
    metaDescription:
      'Fresh, residue-free vegetables grown without chemical pesticides or synthetic fertilizers in Kisarawe, Tanzania. Same-day delivery to Dar es Salaam. Order via WhatsApp or our app.',
    keywords: [
...
export function buildServiceJsonLd(service) {
  return {
    ...
    availableChannel: [
      {
        '@type': 'ServiceChannel',
        serviceUrl: 'https://wa.me/255767211422',
