...
export const S = {
  ...
  // Delivery cutoff messaging — owner-requested 2026-08-03 ("thin strip banner
  // on main page … and also on the checkout screen so people know when it will
  // be delivered by"). Derived from FAQ_DELIVERY; strip wording is the owner's.
  // The 2 PM value itself lives in lib/order/delivery.js.
  DELIVERY_STRIP_SAME_DAY: 'For same-day delivery, order by 2 PM',
  DELIVERY_STRIP_NEXT_DAY: 'Orders placed now are delivered tomorrow',
  CHECKOUT_DELIVERY_LABEL: 'Expected delivery',
  CHECKOUT_DELIVERY_TODAY: 'Today',
  CHECKOUT_DELIVERY_TOMORROW: 'Tomorrow',

  // Promo banner — verbatim from the phone app (HomeScreen.tsx:429,438).
  PROMO_BANNER_SAVE: 'Save TSH',
  PROMO_BANNER_CODE: 'Use code:',

  // Cart extras — features approved by the owner 2026-08-03; wording is new to
  // the web app and pending owner proof-read (checklist §6).
  CART_REMINDER_ONE: 'You left 1 item in your cart',
  CART_REMINDER_MANY: (n) => `You left ${n} items in your cart`,
  CART_REMINDER_ACTION: 'View cart',
  SAVE_FOR_LATER: 'Save for later',
  SAVED_FOR_LATER_TITLE: 'Saved for later',
  MOVE_TO_CART: 'Move to cart',

  // Related products — feature approved by the owner 2026-08-03; wording new
  // to the web app and pending owner proof-read.
