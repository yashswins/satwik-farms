 ...
 *
 * Returns the BARE asset URL — no width/format transform. Sizing lives in
 * lib/order/imageLoader.js, where next/image drives the width per rendered
 * slot instead of every screen fetching one fixed size.
 */
