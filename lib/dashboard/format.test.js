...
describe('rangeLabel', () => {
  it('collapses a single day and joins a range with an en dash', async () => {
    const { rangeLabel } = await import('./format.js');
    expect(rangeLabel('2026-09-04', '2026-09-04')).toBe('Fri 4 Sep');
    expect(rangeLabel('2026-09-01', '2026-09-04')).toBe('Tue 1 Sep – Fri 4 Sep');
    expect(rangeLabel(null, '2026-09-04')).toBe('');
  });
});
